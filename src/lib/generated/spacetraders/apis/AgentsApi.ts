...
export class AgentsApi extends runtime.BaseAPI {
    ...
    async getAgentRaw(requestParameters: GetAgentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetMyAgent200Response>> {
        if (requestParameters.agent_symbol === null || requestParameters.agent_symbol === undefined) {
            throw new runtime.RequiredError('agent_symbol','Required parameter requestParameters.agent_symbol was null or undefined when calling getAgent.');
        }
        ...
        const response = await this.request({
            path: `/agents/{agentSymbol}`.replace(`{${"agentSymbol"}}`, encodeURIComponent(String(requestParameters.agent_symbol))),
            method: 'GET',
