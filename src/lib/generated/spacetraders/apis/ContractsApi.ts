...
export class ContractsApi extends runtime.BaseAPI {
    ...
    async acceptContractRaw(requestParameters: AcceptContractRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<AcceptContract200Response>> {
        if (requestParameters.contract_id === null || requestParameters.contract_id === undefined) {
            throw new runtime.RequiredError('contract_id','Required parameter requestParameters.contract_id was null or undefined when calling acceptContract.');
        }
        ...
        const response = await this.request({
            path: `/my/contracts/{contractId}/accept`.replace(`{${"contractId"}}`, encodeURIComponent(String(requestParameters.contract_id))),
            method: 'POST',
    ...
    async deliverContractRaw(requestParameters: DeliverContractOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeliverContract200Response>> {
        if (requestParameters.contract_id === null || requestParameters.contract_id === undefined) {
            throw new runtime.RequiredError('contract_id','Required parameter requestParameters.contract_id was null or undefined when calling deliverContract.');
        }
        ...
        const response = await this.request({
            path: `/my/contracts/{contractId}/deliver`.replace(`{${"contractId"}}`, encodeURIComponent(String(requestParameters.contract_id))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: DeliverContractRequestToJSON(requestParameters.deliver_contract_request),
        }, initOverrides);
    ...
    async fulfillContractRaw(requestParameters: FulfillContractRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FulfillContract200Response>> {
        if (requestParameters.contract_id === null || requestParameters.contract_id === undefined) {
            throw new runtime.RequiredError('contract_id','Required parameter requestParameters.contract_id was null or undefined when calling fulfillContract.');
        }
        ...
        const response = await this.request({
            path: `/my/contracts/{contractId}/fulfill`.replace(`{${"contractId"}}`, encodeURIComponent(String(requestParameters.contract_id))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getContractRaw(requestParameters: GetContractRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetContract200Response>> {
        if (requestParameters.contract_id === null || requestParameters.contract_id === undefined) {
            throw new runtime.RequiredError('contract_id','Required parameter requestParameters.contract_id was null or undefined when calling getContract.');
        }
        ...
        const response = await this.request({
            path: `/my/contracts/{contractId}`.replace(`{${"contractId"}}`, encodeURIComponent(String(requestParameters.contract_id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
