...
export class SystemsApi extends runtime.BaseAPI {
    ...
    async getConstructionRaw(requestParameters: GetConstructionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetConstruction200Response>> {
        if (requestParameters.system_symbol === null || requestParameters.system_symbol === undefined) {
            throw new runtime.RequiredError('system_symbol','Required parameter requestParameters.system_symbol was null or undefined when calling getConstruction.');
        }

        if (requestParameters.waypoint_symbol === null || requestParameters.waypoint_symbol === undefined) {
            throw new runtime.RequiredError('waypoint_symbol','Required parameter requestParameters.waypoint_symbol was null or undefined when calling getConstruction.');
        }
        ...
        const response = await this.request({
            path: `/systems/{systemSymbol}/waypoints/{waypointSymbol}/construction`.replace(`{${"systemSymbol"}}`, encodeURIComponent(String(requestParameters.system_symbol))).replace(`{${"waypointSymbol"}}`, encodeURIComponent(String(requestParameters.waypoint_symbol))),
            method: 'GET',
    ...
    async getJumpGateRaw(requestParameters: GetJumpGateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetJumpGate200Response>> {
        if (requestParameters.system_symbol === null || requestParameters.system_symbol === undefined) {
            throw new runtime.RequiredError('system_symbol','Required parameter requestParameters.system_symbol was null or undefined when calling getJumpGate.');
        }

        if (requestParameters.waypoint_symbol === null || requestParameters.waypoint_symbol === undefined) {
            throw new runtime.RequiredError('waypoint_symbol','Required parameter requestParameters.waypoint_symbol was null or undefined when calling getJumpGate.');
        }
        ...
        const response = await this.request({
            path: `/systems/{systemSymbol}/waypoints/{waypointSymbol}/jump-gate`.replace(`{${"systemSymbol"}}`, encodeURIComponent(String(requestParameters.system_symbol))).replace(`{${"waypointSymbol"}}`, encodeURIComponent(String(requestParameters.waypoint_symbol))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getMarketRaw(requestParameters: GetMarketRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetMarket200Response>> {
        if (requestParameters.system_symbol === null || requestParameters.system_symbol === undefined) {
            throw new runtime.RequiredError('system_symbol','Required parameter requestParameters.system_symbol was null or undefined when calling getMarket.');
        }

        if (requestParameters.waypoint_symbol === null || requestParameters.waypoint_symbol === undefined) {
            throw new runtime.RequiredError('waypoint_symbol','Required parameter requestParameters.waypoint_symbol was null or undefined when calling getMarket.');
        }
        ...
        const response = await this.request({
            path: `/systems/{systemSymbol}/waypoints/{waypointSymbol}/market`.replace(`{${"systemSymbol"}}`, encodeURIComponent(String(requestParameters.system_symbol))).replace(`{${"waypointSymbol"}}`, encodeURIComponent(String(requestParameters.waypoint_symbol))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getShipyardRaw(requestParameters: GetShipyardRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetShipyard200Response>> {
        if (requestParameters.system_symbol === null || requestParameters.system_symbol === undefined) {
            throw new runtime.RequiredError('system_symbol','Required parameter requestParameters.system_symbol was null or undefined when calling getShipyard.');
        }

        if (requestParameters.waypoint_symbol === null || requestParameters.waypoint_symbol === undefined) {
            throw new runtime.RequiredError('waypoint_symbol','Required parameter requestParameters.waypoint_symbol was null or undefined when calling getShipyard.');
        }
        ...
        const response = await this.request({
            path: `/systems/{systemSymbol}/waypoints/{waypointSymbol}/shipyard`.replace(`{${"systemSymbol"}}`, encodeURIComponent(String(requestParameters.system_symbol))).replace(`{${"waypointSymbol"}}`, encodeURIComponent(String(requestParameters.waypoint_symbol))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getSystemRaw(requestParameters: GetSystemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSystem200Response>> {
        if (requestParameters.system_symbol === null || requestParameters.system_symbol === undefined) {
            throw new runtime.RequiredError('system_symbol','Required parameter requestParameters.system_symbol was null or undefined when calling getSystem.');
        }
        ...
        const response = await this.request({
            path: `/systems/{systemSymbol}`.replace(`{${"systemSymbol"}}`, encodeURIComponent(String(requestParameters.system_symbol))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getSystemWaypointsRaw(requestParameters: GetSystemWaypointsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetSystemWaypoints200Response>> {
        if (requestParameters.system_symbol === null || requestParameters.system_symbol === undefined) {
            throw new runtime.RequiredError('system_symbol','Required parameter requestParameters.system_symbol was null or undefined when calling getSystemWaypoints.');
        }
        ...
        const response = await this.request({
            path: `/systems/{systemSymbol}/waypoints`.replace(`{${"systemSymbol"}}`, encodeURIComponent(String(requestParameters.system_symbol))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getWaypointRaw(requestParameters: GetWaypointRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetWaypoint200Response>> {
        if (requestParameters.system_symbol === null || requestParameters.system_symbol === undefined) {
            throw new runtime.RequiredError('system_symbol','Required parameter requestParameters.system_symbol was null or undefined when calling getWaypoint.');
        }

        if (requestParameters.waypoint_symbol === null || requestParameters.waypoint_symbol === undefined) {
            throw new runtime.RequiredError('waypoint_symbol','Required parameter requestParameters.waypoint_symbol was null or undefined when calling getWaypoint.');
        }
        ...
        const response = await this.request({
            path: `/systems/{systemSymbol}/waypoints/{waypointSymbol}`.replace(`{${"systemSymbol"}}`, encodeURIComponent(String(requestParameters.system_symbol))).replace(`{${"waypointSymbol"}}`, encodeURIComponent(String(requestParameters.waypoint_symbol))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async supplyConstructionRaw(requestParameters: SupplyConstructionOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SupplyConstruction201Response>> {
        if (requestParameters.system_symbol === null || requestParameters.system_symbol === undefined) {
            throw new runtime.RequiredError('system_symbol','Required parameter requestParameters.system_symbol was null or undefined when calling supplyConstruction.');
        }

        if (requestParameters.waypoint_symbol === null || requestParameters.waypoint_symbol === undefined) {
            throw new runtime.RequiredError('waypoint_symbol','Required parameter requestParameters.waypoint_symbol was null or undefined when calling supplyConstruction.');
        }
        ...
        const response = await this.request({
            path: `/systems/{systemSymbol}/waypoints/{waypointSymbol}/construction/supply`.replace(`{${"systemSymbol"}}`, encodeURIComponent(String(requestParameters.system_symbol))).replace(`{${"waypointSymbol"}}`, encodeURIComponent(String(requestParameters.waypoint_symbol))),
            method: 'POST',
            headers: headerParameters,
            query: queryParameters,
            body: SupplyConstructionRequestToJSON(requestParameters.supply_construction_request),
        }, initOverrides);
