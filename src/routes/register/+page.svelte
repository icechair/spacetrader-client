<script>
	...
	import { faction_symbols, FactionSymbol, register } from '$lib/spacetraders.js';
	...
	const faction_items = Object.entries(faction_symbols).map(([name, value]) => ({ value, name }));
...
<div class="mb-6">
	...
	<Input id="agent_symbol" placeholder="choose a name" bind:value={agent_symbol} />
</div>
<div class="mb-6">
